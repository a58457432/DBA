...
#coding=utf-8
#Creator: sjh
#UpdateTime: 2023-06-12 13:30:05

import pymysql


dbconfig = {}
dbconfig['host'] = '192.168.252.23'
dbconfig['port'] = 3306
dbconfig['user'] = 'dba'
dbconfig['passwd'] = 'dba'
dbconfig['db'] = 'ZabbixAlert_text'
dbconfig['charset'] = 'utf8'                                                                                                      


class MySQL(object): # 继承object类所有方法
    '''
    构造方法：
    config = {
        'host': '127.0.0.1',
    ...
    def insertone(self, tablename, param):
        key = []
        value = []
        ...
        sql = 'insert into %s' % tablename
        #vl = tuple(value)
        sql = sql + '(' + ','.join(key) + ')' + ' values ' + '(' + "'" + str(value[0]) + "'" + ');'
        #print(value)
        print('_insert:' + sql) 
        self.executeCommit(sql)
